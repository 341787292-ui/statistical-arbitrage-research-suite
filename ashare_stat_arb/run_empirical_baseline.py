...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run the JQData CSI 500 PCA-OU baseline.")
    ...
    start_index = int(np.searchsorted(panel.dates, development_start))
    ...
    payload = {
        "label": "jqdata-csi500-pca-ou-long-only-baseline",
